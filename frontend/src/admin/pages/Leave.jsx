    ...
    return (
        <>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl ">
                ...
                <div className="  p-3 h-[calc(77vh-1rem)]  overflow-auto">
                    ...
                    <div className='shadow'>
                        <div className='flex text-blue-400'>
                            ...
                            <div className='p-2 font-semibold w-20'>Name</div>
                            <div className='p-2 font-semibold w-35'>Email</div>

                            <div className='p-2 font-semibold w-25'>Leave Type</div>
                            <div className='p-2 font-semibold w-25'>Total Days</div>
                            <div className='p-2 font-semibold w-25'>From</div>
                            <div className='p-2 font-semibold w-25'>To</div>
                            ...
                            leaveSummary && leaveSummary.map((data, index) => {
                                return (
                                    ...
                                    <div className='flex text-blue-300 hover:bg-blue-50 dark:hover:bg-indigo-500' key={data._id}>
                                        ...
                                        <div className='p-2 w-20'>{data.name}</div>
                                        <div className='p-2 w-35'>{data.email}</div>

                                        <div className='p-2 w-25 text-center'>{data.leave_type}</div>
                                        <div className='p-2 w-25 text-green-300 text-center'>{data.total_leave_days}</div>
                                        <div className='p-2 w-25'>{new Date(data.date_from).toLocaleDateString()}</div>
                                        <div className='p-2 w-25'>{new Date(data.date_to).toLocaleDateString()}</div>
                                        <div className='p-2 w-35 text-center text-green-500'>
